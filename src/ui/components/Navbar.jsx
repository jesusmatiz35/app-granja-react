...
export const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-sm p-2" style={ { background: "linear-gradient(135deg, #3f6326 0%,rgb(101, 153, 64) 100%)", position: 'fixed', width: '100%', marginBottom: '45px', zIndex: '1000' } } >
